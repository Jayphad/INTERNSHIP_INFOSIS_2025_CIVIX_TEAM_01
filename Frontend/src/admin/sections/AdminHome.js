...
import AdminPetitionsSection from './AdminPetitionsSection';


  const AdminDashboardHome = ({ user, setCurrentSection }) => {
                ...
                <ContentCard title="Quick Actions" icon={ArrowRight}>
                  <div className="quick-actions-list">
                   <FormButton
                      variant="primary"
                      onClick={() => {
                        localStorage.setItem("openAdminCreatePetition", "true");
                        setCurrentSection("adminPetitions");   // must match routing id
                      }}
                    >
                      <FileText size={18} /> Create Petition
                    </FormButton>
